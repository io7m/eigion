...
public record EISVProtocolSupported(
  String id,
  BigInteger versionMajor,
  BigInteger versionMinor,
  String endpointPath)
  implements Comparable<EISVProtocolSupported>
{
  /**
   * A supported protocol.
   *
  ...
  public int compareTo(
    final EISVProtocolSupported other)
  {
    return Comparator.comparing(EISVProtocolSupported::versionMajor)
      .thenComparing(EISVProtocolSupported::versionMinor)
      .compare(this, other);
  }
}

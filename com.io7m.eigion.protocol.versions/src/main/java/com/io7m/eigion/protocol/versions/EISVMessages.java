...
package com.io7m.eigion.protocol.versions;
...
import com.io7m.eigion.protocol.versions.dto.EISVProtocolSupportedJSON;
import com.io7m.eigion.protocol.versions.dto.EISVProtocolsJSON;
...
public final class EISVMessages
  implements EIProtocolMessagesType<EISVMessageType>,
  EIServiceType
{
  /**
  ...
  public EISVMessages()
  {
    this.serializers =
      DmJsonRestrictedDeserializers.builder()
        ...
        .allowClassName(
          "java.util.List<com.io7m.eigion.protocol.versions.dto.EISVProtocolSupportedJSON>")
        .build();

...
public final class EISecurity
{
  private static volatile EISecPolicyType POLICY =
    EISecPolicyDefault.get();
  ...
  public static EISecPolicyResultType check(

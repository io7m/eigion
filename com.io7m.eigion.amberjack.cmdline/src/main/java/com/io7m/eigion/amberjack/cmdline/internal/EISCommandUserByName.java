...
public final class EISCommandUserByName
  extends EISAbstractCommand
{
  ...
  public EISCommandUserByName(
    final EISController inController,
    final EISStrings inStrings)
  {
    super(inController, inStrings, "user-by-name");
  }
    ...
    throws EIAClientException, InterruptedException
  {
    ...
    if (arguments.isEmpty()) {
      writer.println(this.strings().format("user-by-name.missingName"));
      return FAILURE;
    }

    final var name = arguments.get(0);

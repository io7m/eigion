...
public final class EISCommandAdminCreate
  extends EISAbstractCommand<EISCommandAdminCreate.Parameters>
{
  /**
   * Create a admin.
   *
  ...
  public EISCommandAdminCreate(
    final EISController inController,
    final EISStrings inStrings)
  {
    super(inController, inStrings, "admin-create");
  }
    ...
    throws EIAClientException, InterruptedException
  {
    ...
    EISAdmins.showAdmin(this.strings(), terminal, admin);
    return SUCCESS;
  }
    ...
    implements EISParameterHolderType
  {
    ...
    @Parameter(
      ...
      required = false,
      converter = EISAdminPermissionConverter.class,
      names = "--permissions")
    private Set<EIAdminPermission> permissions = Set.of();

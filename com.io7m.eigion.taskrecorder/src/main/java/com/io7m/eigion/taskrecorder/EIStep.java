...
public final class EIStep implements EIStepType
{
  private final Logger logger;
  private final String name;
  private EIResolutionType resolution;
    ...
    final String inName)
  {
    ...
    this.resolution = new EISucceeded("");
  }
    ...
    final String message)
  {
    ...
    this.resolution = new EISucceeded(message);
  }

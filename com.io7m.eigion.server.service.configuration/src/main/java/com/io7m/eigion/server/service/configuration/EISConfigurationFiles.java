...
import com.io7m.eigion.server.api.EIServerConfigurationFile;
import com.io7m.eigion.server.api.EIServerDatabaseConfiguration;
import com.io7m.eigion.server.api.EIServerDatabaseKind;
import com.io7m.eigion.server.api.EIServerHTTPConfiguration;
...
import com.io7m.eigion.server.service.configuration.xml.Configuration;
import com.io7m.eigion.server.service.configuration.xml.Database;
import com.io7m.eigion.server.service.configuration.xml.DatabaseKind;
import com.io7m.eigion.server.service.configuration.xml.HTTPService;
import com.io7m.eigion.server.service.configuration.xml.IdStore;
import com.io7m.eigion.server.service.configuration.xml.OpenTelemetry;
...
public final class EISConfigurationFiles
  implements EIServiceType
{
  private static final Logger LOG =
    LoggerFactory.getLogger(EISConfigurationFiles.class);

  /**
   * The configuration file parser.
   */

  public EISConfigurationFiles()
  {
    ...
    throws IOException
  {
    try {
      ...
      final var schema =
        schemas.newSchema(
          EISConfigurationFiles.class.getResource(
            "/com/io7m/eigion/server/service/configuration/configuration-1.xsd")
        );

      final var context =
        JAXBContext.newInstance(
          "com.io7m.eigion.server.service.configuration.xml"
        );
  ...
  {
    return "[EISConfigurationFiles 0x%s]"

...
/**
 * A provider of {@link EISA1Admin} values.
 */

public final class EIArbEISA1AdminProvider extends EIArbAbstractProvider
{
  /**
   * A provider of values.
   */

  public EIArbEISA1AdminProvider()
  {
  ...
  {
    return targetType.isOfType(EISA1Admin.class);
  }
    ...
    final SubtypeProvider subtypeProvider)
  {
    ...
    final var ps =
      Arbitraries.defaultFor(Set.class, EISA1AdminPermission.class);

    final Arbitrary<EISA1Admin> a = Combinators.combine(
      u,
      d,
      e,
      t,

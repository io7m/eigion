...
/**
 * A provider of {@link EISA1GroupInvite} values.
 */

public final class EIArbEISA1GroupInviteProvider extends EIArbAbstractProvider
{
  /**
   * A provider of values.
   */

  public EIArbEISA1GroupInviteProvider()
  {
  ...
  {
    return targetType.isOfType(EISA1GroupInvite.class);
  }

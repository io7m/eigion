...
/**
 * A provider of {@link EIAdmin} values.
 */

public final class EIArbAdminProvider extends EIArbAbstractProvider
{
  /**
   * A provider of values.
   */

  public EIArbAdminProvider()
  {
  ...
  {
    return targetType.isOfType(EIAdmin.class);
  }
    ...
    final SubtypeProvider subtypeProvider)
  {
    ...
    final var ps =
      Arbitraries.defaultFor(Set.class, EIAdminPermission.class);

    final Arbitrary<EIAdmin> a =
      Combinators.combine(u, d, e, t, t, p, ps)
        .as((
              UUID id,

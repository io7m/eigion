...
import com.io7m.eigion.server.controller.amberjack.EISAJCmdGroupSearchByNameNext;
...
public final class EISAJCmdGroupSearchByNameNextTest
  extends EISAJCmdAbstractContract
{
    ...
    throws Exception
  {
    ...
    final var handler = new EISAJCmdGroupSearchByNameNext();
    final var ex =
    ...
    throws Exception
  {
    ...
    final var handler =
      new EISAJCmdGroupSearchByNameNext();
    final var response =
      handler.execute(
        context,
        new EIAJCommandGroupSearchByNameNext()

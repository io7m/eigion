...
import com.io7m.eigion.server.controller.pike.EISPCmdGroupCreateRequestsPrevious;
...
public final class EISPCmdGroupCreateRequestsPreviousTest
  extends EISPCmdAbstractContract
{
    ...
    throws Exception
  {
    ...
    final var handler =
      new EISPCmdGroupCreateRequestsPrevious();
    final var response =
      handler.execute(
        context,

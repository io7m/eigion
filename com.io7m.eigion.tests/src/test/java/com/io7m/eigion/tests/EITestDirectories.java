...
public final class EITestDirectories
{
  private static final Logger LOGGER =
    LoggerFactory.getLogger(EITestDirectories.class);

  private EITestDirectories()
  {
    ...
    throws IOException
  {
    ...
    final var path = Path.of(property).resolve("eigion");
  ...
  public static Path resourceOf(
    ...
    throws IOException
  {
    final var internal = String.format("/com/io7m/eigion/tests/%s", name);

...
import com.io7m.eigion.server.controller.amberjack.EISAJCmdAuditSearchPrevious;
...
public final class EISAJCmdAuditSearchPreviousTest
  extends EISAJCmdAbstractContract
{
    ...
    throws Exception
  {
    ...
    final var handler = new EISAJCmdAuditSearchPrevious();
    final var ex =
    ...
    throws Exception
  {
    ...
    final var handler =
      new EISAJCmdAuditSearchPrevious();
    final var response =
      handler.execute(
        context,
        new EIAJCommandAuditSearchPrevious()

...
@JsonSerialize
@JsonDeserialize
public final class EIv1RichText
  implements EIv1FromV1Type<EIRichText>
{
  ...
  @JsonCreator
  public EIv1RichText(
    final @JsonProperty(value = "Content-Type", required = true) String inType,
    final @JsonProperty(value = "Text", required = true) String inText)
  {
    this.type =
  ...
  @Override
  public Optional<EIRichText> toProduct(
    final URI source,
    final Consumer<ParseStatus> errorConsumer)
  {
    try {
      return Optional.of(new EIRichText(this.type, this.text));
    } catch (final Exception e) {
      errorConsumer.accept(
        ParseStatus.builder()
          .setSeverity(ParseSeverity.PARSE_ERROR)
          .setErrorCode("invalid-rich-text")

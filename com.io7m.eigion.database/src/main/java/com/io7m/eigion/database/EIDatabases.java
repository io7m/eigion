...
package com.io7m.eigion.database;

import com.io7m.anethum.common.ParseException;
import com.io7m.eigion.database.api.EIDatabaseConfiguration;
import com.io7m.eigion.database.api.EIDatabaseFactoryType;
import com.io7m.eigion.database.api.EIDatabaseType;
import com.io7m.eigion.database.internal.EIDatabase;
...
public final class EIDatabases implements EIDatabaseFactoryType
{
    ...
    throws IOException, SQLException
  {
    ...
    try {
      ...
      dataSource.setConnectionAttributes("create=" + (configuration.create() == CREATE_DATABASE));
      ...
      try (var stream = EIDatabases.class.getResourceAsStream(
        "/com/io7m/eigion/database/internal/database.xml")) {

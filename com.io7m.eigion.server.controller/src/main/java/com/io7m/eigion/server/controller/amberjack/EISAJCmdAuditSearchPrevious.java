...
import com.io7m.eigion.server.controller.amberjack.security.EISecAJActionAuditRead;
...
public final class EISAJCmdAuditSearchPrevious
  extends EISAJCmdAbstract<EIAJCommandAuditSearchPrevious>
{
  /**
   * EIAJCommandAuditSearchPrevious
   */

  public EISAJCmdAuditSearchPrevious()
  {
  ...
  protected EIAJResponseType executeActual(
    ...
    final EIAJCommandAuditSearchPrevious command)
    throws EIException
  {

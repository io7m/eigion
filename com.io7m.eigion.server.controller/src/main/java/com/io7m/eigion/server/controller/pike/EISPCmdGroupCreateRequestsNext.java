...
public final class EISPCmdGroupCreateRequestsNext
  extends EISPCmdAbstract<EIPCommandGroupCreateRequestsNext>
{
  /**
   * EIPCommandGroupCreateRequestsNext
   */

  public EISPCmdGroupCreateRequestsNext()
  {
  ...
  protected EIPResponseType executeActual(
    ...
    final EIPCommandGroupCreateRequestsNext command)
    throws EIException
  {
    ...
    final var search =
      session.groupCreationRequestsSearch()

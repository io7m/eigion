...
public final class EISPCmdGroupCreateRequestsPrevious
  extends EISPCmdAbstract<EIPCommandGroupCreateRequestsPrevious>
{
  /**
   * EIPCommandGroupCreateRequestsPrevious
   */

  public EISPCmdGroupCreateRequestsPrevious()
  {
  ...
  protected EIPResponseType executeActual(
    ...
    final EIPCommandGroupCreateRequestsPrevious command)
    throws EIException
  {

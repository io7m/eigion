...
public final class EISAJCmdAuditSearchNext
  extends EISAJCmdAbstract<EIAJCommandAuditSearchNext>
{
  /**
   * EIAJCommandAuditSearchNext
   */

  public EISAJCmdAuditSearchNext()
  {
  ...
  protected EIAJResponseType executeActual(
    ...
    final EIAJCommandAuditSearchNext command)
    throws EIException
  {

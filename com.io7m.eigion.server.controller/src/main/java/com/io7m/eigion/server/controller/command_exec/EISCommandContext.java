...
public abstract class EISCommandContext<E extends EIProtocolMessageType>
{
  ...
  private final EISession userSession;
    ...
    final String inRemoteUserAgent)
  {
    ...
    this.tracer =
      inServices.requireService(EISTelemetryServiceType.class)
        .tracer();
  }
  ...
  public final EISession session()
  {
  ...
  public final EISCommandExecutionFailure failValidity(
  ...
  public final EISCommandExecutionFailure failProtocol(
  ...
  public final EISCommandExecutionFailure failSecurity(

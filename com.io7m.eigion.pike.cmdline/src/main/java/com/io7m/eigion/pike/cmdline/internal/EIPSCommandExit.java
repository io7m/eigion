...
public final class EIPSCommandExit
  extends EIPSAbstractCommand<EIPSCommandExit.Parameters>
{
  /**
   * Exit the shell.
   *
  ...
  protected EIPSCommandResult runActual(
    ...
    final EIPSCommandExit.Parameters parameters)
    throws EIPSExitException
  {
    throw new EIPSExitException(parameters.exitCode);
  }

...
/**
 * Cancel creating a group.
 */

public final class EIPSCommandGroupCreationCancel
  extends EIPSAbstractCommand<EIPSCommandGroupCreationCancel.Parameters>
{
  /**
   * Cancel creating a group.
   *
  ...
  public EIPSCommandGroupCreationCancel(
    final EIPSController inController,
    final EIPStrings inStrings)
  {
    super(inController, inStrings, "group-creation-cancel");
  }
    ...
    throws EIPClientException, InterruptedException
  {
    this.controller()
      .client()
      .groupCreationCancel(new EIToken(parameters.token));

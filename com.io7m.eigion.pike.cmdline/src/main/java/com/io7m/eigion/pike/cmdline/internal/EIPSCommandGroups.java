...
public final class EIPSCommandGroups
  extends EIPSAbstractCommand<EIPSCommandGroups.Parameters>
{
  /**
   * List groups.
   *
  ...
  public EIPSCommandGroups(
    final EIPSController inController,
    final EIPStrings inStrings)
  {
    super(inController, inStrings, "groups");
  }
    ...
    throws EIPClientException, InterruptedException
  {
    ...
    for (final var group : groups) {
      writer.println("%s: %s".formatted(group.group(), group.roles()));
    }
    return SUCCESS;
  }

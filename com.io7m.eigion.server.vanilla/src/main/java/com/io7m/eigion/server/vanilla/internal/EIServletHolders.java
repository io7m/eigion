...
public final class EIServletHolders
{
  ...
  public <T extends Servlet> EIServletHolder<T> create(
    final Class<T> clazz,
    final Function<EIServiceDirectoryType, T> servlets)
  {
    Objects.requireNonNull(clazz, "clazz");
    Objects.requireNonNull(servlets, "servlets");
    return new EIServletHolder<>(clazz, () -> servlets.apply(this.services));
  }
}

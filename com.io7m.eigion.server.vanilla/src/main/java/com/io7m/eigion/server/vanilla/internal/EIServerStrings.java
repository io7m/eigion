...
public final class EIServerStrings extends JXTAbstractStrings
  implements EIServiceType
{
  ...
  public EIServerStrings(
    final Locale locale)
    throws IOException
  {
    super(
      locale,
      EIServerStrings.class,
      "/com/io7m/eigion/server/vanilla/internal",
      "Messages"
    );
  }

...
public final class EIACmdUserUnban
  implements EICommandExecutorType<
  EIACommandContext, EISA1CommandUserUnban, EISA1ResponseType>
{
  /**
   * A command to unban users.
   */

  public EIACmdUserUnban()
  {
  ...
  public EICommandExecutionResult<EISA1ResponseType> execute(
    ...
    final EISA1CommandUserUnban command)
    throws
    EIServerDatabaseException,
    EISecurityException,
    EIHTTPErrorStatusException
  {
    if (EISecurity.check(new EISecAdminActionUserUnban(context.admin()))
    ...
    users.userUnban(command.id());

    return new EICommandExecutionResult<>(
      200,
      new EISA1ResponseUserUnban(
        context.requestId(),

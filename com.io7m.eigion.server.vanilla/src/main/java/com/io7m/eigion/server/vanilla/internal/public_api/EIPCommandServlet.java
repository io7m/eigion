...
public final class EIPCommandServlet extends EIPAuthenticatedServlet
{
  private static final Logger LOG =
    LoggerFactory.getLogger(EIPCommandServlet.class);

  private final EIServerDatabaseType database;
  private final EIRequestLimits limits;
  private final EISP1Messages messages;
  private final EIPCommandExecutor executor;
    ...
    throws Exception
  {
    ...
    try (var input = this.limits.boundedMaximumInput(request, 1048576)) {
      ...
      if (message instanceof EISP1CommandType command) {

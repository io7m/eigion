...
/**
 * The response to {@link EIPCommandGroupsBegin}.
 *
 * @param requestId The request that prompted this response
 * @param groups    The groups in which this user is a member
 */

public record EIPResponseGroups(
  UUID requestId,
  EIPage<EIGroupMembership> groups)

  ...
  public EISA1Messages()
  {
    this.serializers =
      DmJsonRestrictedDeserializers.builder()
        ...
        .allowClass(EISA1Admin.class)
        .allowClass(EISA1AdminPermission.class)
        .allowClass(EISA1AdminSummary.class)
        .allowClass(EISA1AuditEvent.class)
        .allowClass(EISA1CommandAdminCreate.class)
        .allowClass(EISA1CommandAdminGet.class)
        .allowClass(EISA1CommandAdminGetByEmail.class)
        .allowClass(EISA1CommandAdminGetByName.class)
        .allowClass(EISA1CommandAdminSearch.class)
        .allowClass(EISA1CommandAuditGet.class)
        .allowClass(EISA1CommandGroupInviteSetStatus.class)
        .allowClass(EISA1CommandGroupInvites.class)
        ...
        .allowClass(EISA1ResponseAdminCreate.class)
        .allowClass(EISA1ResponseAdminGet.class)
        .allowClass(EISA1ResponseAdminList.class)
        .allowClass(EISA1ResponseAuditGet.class)
        .allowClass(EISA1ResponseError.class)
        .allowClass(EISA1ResponseGroupInviteSetStatus.class)
        .allowClass(EISA1ResponseGroupInviteSetStatus.class)
        .allowClass(EISA1ResponseGroupInvites.class)
        ...
        .allowClassName(listOf(EISA1AdminSummary.class))
        .allowClassName(listOf(EISA1AuditEvent.class))
        .allowClassName(listOf(EISA1CommandType.class))
        .allowClassName(listOf(EISA1GroupInvite.class))
        ...
        .allowClassName(setOf(EISA1AdminPermission.class))

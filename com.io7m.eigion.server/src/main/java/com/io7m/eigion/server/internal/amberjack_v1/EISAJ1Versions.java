...
import com.io7m.eigion.server.internal.EISVerdantMessages;
...
public final class EISAJ1Versions extends HttpServlet
{
  private static final VProtocols PROTOCOLS =
    createProtocols();

  private final EISVerdantMessages messages;
  ...
  public EISAJ1Versions(
    final EIServiceDirectoryType inServices)
  {
    this.messages =
      inServices.requireService(EISVerdantMessages.class);
  }
  ...
  {
    try {
      response.setContentType(EISVerdantMessages.contentType());

...
public final class EISAJCmdGroupSearchByNameBegin
  extends EISAJCmdAbstract<EIAJCommandGroupSearchByNameBegin>
{
  /**
   * EIAJCommandGroupSearchByNameBegin
   */

  public EISAJCmdGroupSearchByNameBegin()
  {
  ...
  protected EIAJResponseType executeActual(
    ...
    final EIAJCommandGroupSearchByNameBegin command)
    throws EIException
  {
    ...
    final var search =
      groups.groupSearchByName(command.parameters());
    final var page =
      search.pageCurrent(groups);

    session.setGroupSearchByName(search);

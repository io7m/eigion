...
public abstract class EISAJCmdAbstract<C extends EIProtocolMessageType> implements
  EISCommandExecutorType<EISAJCommandContext, C, EIAJResponseType>
{
  protected EISAJCmdAbstract()
  {

  }

  @Override
  public final EIAJResponseType execute(

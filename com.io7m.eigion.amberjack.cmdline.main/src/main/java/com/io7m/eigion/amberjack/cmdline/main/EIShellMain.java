...
public final class EIShellMain
{
  ...
  private static final class Parameters
  {
    ...
    @Parameter(
      ...
      required = false)
    private EIVerbosity level = EIVerbosity.INFO;
  ...
  private static int run()
    throws IOException, EIAClientException, InterruptedException
  {
    final var clients =
  ...
  {
    EISLoggingPatternLayout.enableLoggerDisplay(parameters.logClasses);

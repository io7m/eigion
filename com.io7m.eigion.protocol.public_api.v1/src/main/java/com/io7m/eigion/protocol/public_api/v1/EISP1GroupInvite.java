...
public record EISP1GroupInvite(
  ...
  Optional<OffsetDateTime> timeCompleted)
{
  ...
  @EIProtocolFromModel
  public static EISP1GroupInvite ofInvite(
    final EIGroupInvite i)
  {
    return new EISP1GroupInvite(
      ...
      i.group().value(),
      i.token().value(),
      EISP1GroupInviteStatus.ofStatus(i.status()),
      i.timeStarted(),
      i.timeCompleted()
    );
  }

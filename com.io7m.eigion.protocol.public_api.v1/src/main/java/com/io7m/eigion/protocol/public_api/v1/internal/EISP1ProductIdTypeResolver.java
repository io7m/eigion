...
package com.io7m.eigion.protocol.public_api.v1.internal;
...
public final class EISP1ProductIdTypeResolver implements TypeIdResolver
{
  ...
  public String idFromValue(
    final Object o)
  {
    return Optional.ofNullable(EISP1JsonType.TYPE_ID_FOR_CLASS.get(o.getClass()))
      .orElseThrow(() -> {
  ...
  public JavaType typeFromId(
    ...
    throws IOException
  {
    return Optional.ofNullable(EISP1JsonType.CLASS_FOR_TYPE_ID.get(id))
      .map(c -> {

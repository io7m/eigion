...
public interface EIServiceDirectoryType extends Closeable
{
  /**
  ...
  <T extends EIServiceType> Optional<T> optionalService(
    Class<T> clazz);
   ...
   *
   * @throws EIServiceException If no service exists
   */

  <T extends EIServiceType> T requireService(
    Class<T> clazz)
   ...
   *
   * @throws EIServiceException If no required
   */

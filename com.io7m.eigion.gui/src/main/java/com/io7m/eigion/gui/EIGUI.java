...
public final class EIGUI
{
  private final EIGApplication app;

  private EIGUI(
    final EIGApplication inApp)
  {
  ...
  public static EIGUI start(
    final EIGConfiguration configuration)
    throws Exception
  {
    final var stage = new Stage();
    final var app = new EIGApplication(configuration);
    app.start(stage);
    return new EIGUI(app);
  }
}

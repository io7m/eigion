...
/**
 * The type of screen controllers that require services.
 */

public sealed interface EIScreenControllerWithServicesType
  extends EIScreenControllerType
  permits EIGDashboardController,
  EIGLoginScreenController,
  EIGNewsController,
  EIGServicesScreenController
{
